      ...
      <form className="mt-10 space-y-8">
        ...
        <div>
          ...
          <textarea
            ...
            className="min-h-[220px] w-full resize-none rounded-2xl border border-slate-200 bg-[#F8FAFC] p-5 text-[#124A66] placeholder:text-slate-400 outline-none transition-all duration-300 focus:border-[#E46F21] focus:ring-4 focus:ring-[#E46F21]/10"
          />
